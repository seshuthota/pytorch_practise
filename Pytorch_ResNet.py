...
class block(nn.Module):
    def __init__(self, in_channels, out_channels, identity_downsample=None, stride=1):
        ...
        self.conv2 = nn.Conv2d(out_channels, out_channels, kernel_size=(3, 3), stride=stride, padding=(1, 1))
...
class ResNet(nn.Module):
    def __init__(self, block, layers, img_channels, num_classes):
        ...
        self.in_channels = 64
        self.conv1 = nn.Conv2d(img_channels, 64, kernel_size=(7, 7), stride=(2, 2), padding=(3, 3))
    ...
    def _make_layer(self, block, num_residual_blocks, out_channels, stride):
        ...
        if stride != 1 or self.in_channels != out_channels * 4:
            identity_downsample = nn.Sequential(
                nn.Conv2d(self.in_channels, out_channels * 4, kernel_size=(1, 1), stride=stride),
...
model = ResNet50(3, 1000).to(device)
print(model)
